...
OUTPUT_DIR = f"/mvdlph/shahd/MVCNNPH/results_exp2_stratified_valsplit/{CAMERA_TO_USE}_len{TARGET_LEN}"
os.makedirs(OUTPUT_DIR, exist_ok=True)

print("Experiment: EXP2 Pure CNN + Stratified Train/Test + Stratified Validation")
...
print("\nTrain+Val samples:", len(train_samples_all))
print("Test samples     :", len(test_samples))


# =========================================================
# Stratified train/validation split inside training set
# =========================================================
...
print("\n===== EXP2 Stratified Validation Split Results =====")
print("Camera =", CAMERA_TO_USE)
print("MAE  =", mae)
print("RMSE =", rmse)
print("R2   =", r2)
...
with open(os.path.join(OUTPUT_DIR, "metrics.txt"), "w", encoding="utf-8") as f:
    f.write("===== EXP2 Stratified Validation Split Results =====\n")
    f.write(f"Camera = {CAMERA_TO_USE}\n")
...
print("fit_trials.csv")
print("validation_trials.csv")
