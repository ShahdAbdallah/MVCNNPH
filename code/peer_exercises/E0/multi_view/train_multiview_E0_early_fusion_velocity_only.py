...
OUTPUT_DIR = f"/mvdlph/shahd/MVCNNPH/results_multiview_E0_early_fusion_velocity_only/len{TARGET_LEN}"
os.makedirs(OUTPUT_DIR, exist_ok=True)

print("Experiment: Multi-view E0 Early Fusion Velocity Only")
print("Target exercise:", TARGET_EXERCISE)
print("Fusion: Early fusion")
...
with open(os.path.join(OUTPUT_DIR, "metrics.txt"), "w", encoding="utf-8") as f:
    f.write("===== Multi-view E0 Early Fusion Velocity Only Results =====\n")
...
plt.title("E0 Early Fusion Loss (MSE)")
plt.xlabel("Epoch")
plt.ylabel("Loss")
...
plt.suptitle("E0 Early Fusion RMSE & MAE")
plt.tight_layout()
...
plt.title("E0 Early Fusion True vs Predicted")
plt.grid(True, alpha=0.25)
plt.tight_layout()
