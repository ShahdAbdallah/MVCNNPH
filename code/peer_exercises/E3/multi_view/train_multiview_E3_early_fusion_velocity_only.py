...
OUTPUT_DIR = f"/mvdlph/shahd/MVCNNPH/results_multiview_E3_early_fusion_velocity_only/len{TARGET_LEN}"
os.makedirs(OUTPUT_DIR, exist_ok=True)

print("Experiment: Multi-view E3 Early Fusion Velocity Only")
...
with open(os.path.join(OUTPUT_DIR, "metrics.txt"), "w", encoding="utf-8") as f:
    f.write("===== Multi-view E3 Early Fusion Velocity Only Results =====\n")
...
plt.title("E3 Early Fusion Loss (MSE)")
plt.xlabel("Epoch")
plt.ylabel("Loss")
...
plt.suptitle("E3 Early Fusion RMSE & MAE")
plt.tight_layout()
...
plt.title("E3 Early Fusion True vs Predicted")
plt.grid(True, alpha=0.25)
plt.tight_layout()
