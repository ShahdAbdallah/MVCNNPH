...
FUSION_TYPE = "middle"
FUSION_FOLDER = "middle_fusion"
FUSION_TITLE = "Middle Fusion"
...
merged = Concatenate(axis=-1, name="middle_fusion_concat")([feat_c0, feat_c1, feat_c2])
x = Conv1D(32, 3, activation="relu", padding="same")(merged)
x = BatchNormalization()(x)
