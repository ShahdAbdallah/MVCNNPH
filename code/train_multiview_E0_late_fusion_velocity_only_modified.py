...
OUTPUT_DIR = f"/mvdlph/shahd/MVCNNPH/results_multiview_E0_late_fusion_velocity_only/len{TARGET_LEN}"
os.makedirs(OUTPUT_DIR, exist_ok=True)

print("Experiment: Multi-view E0 Late Fusion Velocity Only")
...
print("Skipped non-E0 files:", skipped_train + skipped_valid + skipped_test)
...
with open(os.path.join(OUTPUT_DIR, "metrics.txt"), "w", encoding="utf-8") as f:
    f.write("===== Multi-view E0 Late Fusion Velocity Only Results =====\n")
    ...
    f.write(f"Skipped non-E0 files = {skipped_train + skipped_valid + skipped_test}\n\n")
...
plt.title("E0 Late Fusion Loss (MSE)")
plt.xlabel("Epoch")
plt.ylabel("Loss")
...
plt.suptitle("E0 Late Fusion RMSE & MAE")
plt.tight_layout()
...
plt.title("E0 Late Fusion True vs Predicted")
plt.grid(True, alpha=0.25)
plt.tight_layout()
