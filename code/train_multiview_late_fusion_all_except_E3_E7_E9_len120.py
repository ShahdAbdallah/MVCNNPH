...
OUTPUT_DIR = f"/mvdlph/shahd/MVCNNPH/results_multiview_late_fusion_all_except_E3_E7_E9_velocity_only/len{TARGET_LEN}"
os.makedirs(OUTPUT_DIR, exist_ok=True)

print("Experiment: Multi-view Late Fusion Velocity Only")
...
merged = Concatenate(name="late_fusion_concat")(
...
with open(
    ...
    f.write("===== Multi-view Late Fusion Velocity Only: All Exercises Except E3, E7, E9 =====\n\n")
    ...
    f.write("Fusion method = Concatenate camera-specific vectors after full CNN branches\n")
...
plt.suptitle("Late Fusion RMSE & MAE")
plt.tight_layout()
plt.savefig(
