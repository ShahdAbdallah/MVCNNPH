...
OUTPUT_DIR = f"/mvdlph/shahd/MVCNNPH/results_multiview_early_fusion_all_except_E3_E7_E9_velocity_only/len{TARGET_LEN}"
...
with open(
    ...
    f.write("===== Multi-view Early Fusion Velocity Only: All Exercises Except E3, E7, E9 =====\n\n")
...
plt.suptitle("Early Fusion RMSE & MAE")
plt.tight_layout()
plt.savefig(
