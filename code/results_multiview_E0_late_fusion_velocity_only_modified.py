...
OUTPUT_DIR = f"/mvdlph/shahd/MVCNNPH/results_multiview_E1_middle_fusion_velocity_only/len{TARGET_LEN}"
os.makedirs(OUTPUT_DIR, exist_ok=True)

print("Experiment: Multi-view E1 Middle Fusion Velocity Only")
...
with open(
    ...
    f.write("===== Multi-view E1 Middle Fusion =====\n\n")
